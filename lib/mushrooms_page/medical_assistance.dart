  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: Container(
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Image(
                    image: AssetImage(
                      'assets/about_mushrooms/arastirma4.png',
                    ),
                    width: 400,
                    height: 400,
                  ),
            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Image(
                    image: AssetImage(
                      'assets/about_mushrooms/medical.gif',
                    ),
                    width: 100,
                    height: 100,
                  ),
                ...
                Container(
                  margin:
                      EdgeInsets.only(left: 10, top: 0, right: 10, bottom: 5),
                  child: SelectableText(
                    "medicaltext".tr,
                    style: TextStyle(
                        fontFamily: 'Comfortaa',
      ...
      floatingActionButton: SpeedDial(
        ...
        backgroundColor: Color.fromRGBO(96, 182, 233, 1),
        children: [
          SpeedDialChild(
          ...
          SpeedDialChild(
              ...
              label: "share".tr,
              backgroundColor: Color.fromRGBO(96, 152, 243, 1),
              onTap: () => {
                    _onShare(context),
                  }),
        ],
