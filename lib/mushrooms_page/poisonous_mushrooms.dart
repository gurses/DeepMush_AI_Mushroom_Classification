...
class PoisonousMushRoute extends StatelessWidget {
  String text =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: Container(
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Image(
                    image: AssetImage(
                      'assets/about_mushrooms/arastirma3.png',
                    ),
                    width: 400,
                    height: 400,
                  ),
      ...
      floatingActionButton: SpeedDial(
        ...
        backgroundColor: Color.fromRGBO(245, 177, 163, 1),
        children: [
          SpeedDialChild(
              child: Icon(Icons.contact_mail),
              label: "contact".tr,
              backgroundColor: Color.fromRGBO(242, 157, 143, 1),
              onTap: () {
                _launchMail();
              }),
          SpeedDialChild(
          ...
          SpeedDialChild(
              ...
              label: "share".tr,
              backgroundColor: Color.fromRGBO(255, 167, 163, 1),
              onTap: () => {
                    _onShare(context),
                  }),
        ],
