...
class AboutMushRoute extends StatelessWidget {
  String text =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <
          ...
          ClipPath(
            ...
            child: Container(
              ...
              color: Color.fromRGBO(140, 198, 249, 1),
              height: 300.0,
              child: Center(
                child: Padding(
                  ...
                  child: Image(
                    image: AssetImage(
                      'assets/about_mushrooms/arastirma2.png',
                    ),
                    width: 400,
                    height: 400,
                  ),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Image(
                    image: AssetImage(
                      'assets/about_mushrooms/mantar_bolge.png',
                    ),
                    width: 373,
                    height: 392,
                  ),
      ...
      floatingActionButton: SpeedDial(
        ...
        backgroundColor: Color.fromRGBO(140, 118, 249, 1),
        children: [
          SpeedDialChild(
              child: Icon(Icons.contact_mail),
              label: "contact".tr,
              backgroundColor: Color.fromRGBO(140, 168, 249, 1),
              onTap: () {
                _launchMail();
              }),
          SpeedDialChild(
              ...
              label: "rate".tr,
              backgroundColor: Color.fromRGBO(140, 148, 249, 1),
